...
def train_logistic_regression(processed_data_uri: str, output_model_uri: str):
    """
    Downloads processed data from GCS, trains a Logistic Regression model,
...
if __name__ == '__main__':
    ...
    train_logistic_regression(args.processed_data_uri, args.output_model_uri)