...
def train_decision_tree(processed_data_uri: str, output_model_uri: str):
    """
    Downloads processed data from GCS, trains a Decision Tree model,
...
if __name__ == '__main__':
    ...
    train_decision_tree(args.processed_data_uri, args.output_model_uri)