...
def evaluate_and_decide(
    ...
    """
    Evaluates candidate models on the test set, compares the best one
    against the production model, and PRINTS the name of the winning
    candidate model or 'keep_old'.
    """
