...
def trigger_cloud_build(project_id: str, trigger_id: str, new_model_uri: str):
    print(f"Preparing to trigger Cloud Build job '{trigger_id}' in project '{project_id}'.")
    ...
    print(f"Sending request to Cloud Build API.")
...
if __name__ == "__main__":
    ...
    trigger_cloud_build(args.project_id, args.trigger_id, args.new_model_uri)