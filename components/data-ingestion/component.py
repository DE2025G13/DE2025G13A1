...
def upload_error_log(bucket_name: str, error_message: str):
    ...
    try:
        ...
        print(f"FATAL: Could not upload error log to GCS. Logging Error: {e}")
...
def ingest_data(
    ...
    try:
        ...
        raise # Re-raise the exception to fail the pipeline step
...
if __name__ == '__main__':
    ...
    # FIX: Corrected the function name from ingest__data to ingest_data
    ingest_data(
        args.bucket_name,
        args.blob_name,
