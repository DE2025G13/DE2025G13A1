...
IMAGE_REGISTRY_PATH = "europe-west4-docker.pkg.dev/braided-voyage-472209-n6/daan-wine-repo"
...
def wine_quality_pipeline(
    input_data_gcs_path: str = "gs://daan-pipeline-root/datasets/wine-latest.csv",
    project_id: str = "braided-voyage-472209-n6",
    model_bucket: str = "daan-wine-models",
